...
resource "aws_launch_template" "main" {
  ...
  # Once the instances are created these will become, instances' tags
  tag_specifications {
...
# once the instances are created, these will become volume's tags
  tag_specifications {
...
# launch template resource's tags
  tags = merge(
     {
        Name = "${local.common_name}-${var.app_version}-${aws_instance.main.id}"
     },
